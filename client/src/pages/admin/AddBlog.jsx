...
const AddBlog = () => {
  ...
  return (
    <form onSubmit={onSubmitHandler} className='flex-1 bg-blue-50/50 text-gray-600 h-full overflow-scroll'>
        <div className='bg-white w-full p-4 max-w-3xl sm:m-10 shadow rounded '>
            ...
            <input type="text" placeholder='type here' required className='
                w-full max-w-lg mt-2 p-2 border border-gray-300 rounded outline-none 
            ...
            <div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative'>
                ...
                {loading && (<div className='absolute top-0 bottom-0 right-0 left-0 flex 
                items-center justify-center bg-bloack/20 mt-2'>
