        ...
        <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
            ...
            <div className='max-w-3xl mx-auto'>
                ...
                <form onSubmit={addComment} className='flex flex-col items-start gap-4 max-w-lg'>
                    ...
                    <input onChange={(e)=> setData(e.target.value)}  value={name} type="text" placeholder='Name' required 
                    className='w-full p-2 border border-gray-300 rounded outline-none'/>

                    <textarea onChange={(e)=> setData(e.target.value)}  value={content} placeholder='Comment' 
            ...
            <div className='my-24 max-w-3xl mx-auto'>
                <p className='font-semibold my-4'>Share the post</p>
                <div className='flex'>
